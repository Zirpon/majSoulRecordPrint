...
if __name__ == '__main__':
    ...
    def loadWindowUrl(window):
        ...
        # 关联 windowtmp 窗口的关闭事件和回调函数  
        window.events.closed += on_closed
        GLOBALS.get_value('WINDOWS_SET').append(window)

    # 使用 webview.start 启动应用程序，传入 loadWindowUrl 函数作为加载 URL 的回调函数
