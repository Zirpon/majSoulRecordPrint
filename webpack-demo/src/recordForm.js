              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right" sx={{color: 'blue',backgroundColor: '#2196f3',}}>{row.Curpt}</TableCell>
                    <TableCell align="right" sx={{color: 'blue',backgroundColor: '#ffebee',}}>{row.rank}</TableCell>
                    <TableCell align="right">{row.rankTitle}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
